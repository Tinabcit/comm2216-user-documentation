...
1. [Installation](body.md)
2. [Player](player.md)
3. [Enemy](enemy.md)
4. [Tilemaps and Levels](tilemaps-levels.md)
...
- Screenshots: When being given an instruction that requires navigating to a specific part of the page, marked screenshots will be provided.
    ...
    > ![MakeCode Arcade menu for sprite code blocks](img/player_1.png "Makecode Arcade meny for sprite code blocks")
